# 📖 Lecturas Diarias — Guía de Campo

**Objetivo:** Manual técnico práctico. 10 min/día.
**Formato:** Qué es → Cómo funciona → Pasos prácticos → Ejemplo real → Reto del día.
**Selección:** Aleatoria del pool de temas pendientes.

---

## Categorías

| ID | Categoría | Enfoque |
|----|-----------|---------|
| A | 🧠 Psicología Aplicada | Sesgos, hábitos, toma de decisiones, persuasion |
| B | 💰 Negocio y E-commerce | Ventas, pricing, tráfico, retención, unit economics |
| C | 📈 Finanzas Personales | Inversión,Compound Interest, gestión de deuda, cashflow |
| D | 🏋️ Fitness y Rendimiento | Nutrición, entrenamiento, recuperación, hábitos físicos |
| E | ⚡ Productividad y Sistemas | Automatización, workflows, herramientas, output |
...
- [ ] CAC vs LTV — La métrica que determina si creces o te quemás
...
- [ ] Dolar Cost Averaging — Cómo invertir sin intentar adivinar el mercado
- [ ] Cashflow vs Patrimonio — Por qué ser "rico" en papel no es ser rico
- [ ] Impuestos Legales — Deducciones y estrategias fisales para emprendedores
- [ ] Likuidad vs Rentabilidad — El tradeoff que todo inversionista debe entender
...
- [ ] Macros: Carbos, Grasas, Proteínas — Cuándo y por qué importa cada uno
- [ ] Entrenamiento de Fuerza vs Resistencia — Diferencias reales y cuándo usar cada uno
- [ ] Suplementación Real — Qué funciona, qué es marketing, qué es veneno
- [ ] Consistencia vs Intensidad — Por qué 3 días/sempre gana a 6 días 1 mes
- [ ] Estrés y Cortisol — Cómo el estrés sabotea tu cuerpo sin que lo notes
- [ ] Ayuno Intermitente — Lo que dice la ciencia vs lo que dice Instagram
- [ ] Conexión Mente-Cuerzo — Cómo el ejercicio físico mejora rendimiento mental
...
- [ ] Hábitos Atómicos — El sistema de James Clear para construir hábitos que duren
...
### F — 🔧 Tech y Herramientas
- [ ] IA Generativa para Negocios — Cómo usar ChatGPT/Claude para vender más
- [ ] No-Code / Low-Code — Herramientas para crear sin programar
- [ ] Automatización con Make/Zapier — Conectar apps sin saber código
- [ ] Analytics Básicos — Métricas que todo emprendedor digital debe mirar
- [ ] SEO Práctico — Cómo aparecer en Google sin pagar publicidad
- [ ] Email Marketing — Secuencias que convierten (no que enterran en spam)
- [ ] CRM y Funnel — Organizar relaciones con clientes sin perder ninguno
- [ ] Cloud y Almacenamiento — Dónde guardar datos de forma segura y barata
...
- [ ] Edición en Capas — Flujo de trabajo profesional en CapCut/Premiere
- [ ] Color Grading — Cómo el color cambia la emoción de un video
- [ ] Sonido > Imagen — Por qué el audio malo arruina el mejor video
- [ ] Hooks de 3 Segundos — Las primeras palabras que deciden si te ven o scrolleán
- [ ] Repurposing — Cómo convertir 1 video en 10 piezas de contenido
- [ ] Thumbnail Science — Diseño de miniaturas que generan clics
- [ ] Métricas de Video — Qué significan watch time, retention, CTR y cómo mejorarlos
- [ ] Producción con Celular — Flujo de trabajo completo sin equipo profesional
- [ ] Voiceover y Narración — Técnicas para sonar natural y convincente
- [ ] Contenido Evergreen vs Trending — Cuándo crear cada tipo y por qué
...
- [ ] Gestión del Ego — Por qué el éxito temprano es el mayor riesgo
...
| Fecha | ID | Tema |
|-------|-----|------|
| 2026-07-16 | H | Estoicismo: Controla lo que puedes, suelta lo que no (Epicteto) |
| 2026-07-17 | H | Incertidumbre + Tao: Abrazar lo desconocido |
| 2026-07-18 | A | Ley de Vibración — Todo se mueve, todo vibra |
| 2026-07-19 | H | Mentalismo + Meditación: El poder de la mente enfocada |
| 2026-07-20 | A | Ley del Mentalismo — El Universo es Mental |
| 2026-07-21 | B | Ley de la Atracción — Energía similar se atrae |
| 2026-07-22 | C | Primera Ley de la Termodinámica — Energía no se crea ni se destruye |
| 2026-07-23 | H | Tao: El camino del agua — fluir, no forzar (Lao Tse) |
| 2026-07-24 | H | Entropía + Ley del Movimiento: Por qué la disciplina vence al caos |
| 2026-07-25 | A | Ley de Correspondencia — Como es arriba, es abajo |
| 2026-07-26 | A | Ley de Polaridad — Todo es dual |
| 2026-07-27 | A | Ley de Ritmo — Todo fluye y refluye |
| 2026-07-28 | B | Ley de la Abundancia — Hay suficiente para todos |
| 2026-07-29 | C | Entropía — Todo tiende al desorden |
| 2026-07-30 | H | Meditaciones: Diario de un emperador filósofo (Marco Aurelio) |
| 2026-07-31 | H | Causa y Efecto + Karma: Cómo todo se conecta |
| 2026-08-01 | H | Vibración + Atracción: La ciencia detrás de "piensa y serás rico" |
| 2026-08-02 | A | Ley de Causa y Efecto — "Toda causa tiene su efecto" |
| 2026-08-03 | A | Ley de Género — "El género está en todo" |
| 2026-08-04 | B | Ley del Movimiento — La inacción es más costosa que la acción |
| 2026-08-05 | C | Ley de Gravedad — Lo que sube debe bajar (riesgo/recompensa) |
| 2026-08-06 | H | El arte de la guerra: Conócete a ti mismo (Sun Tzu) |
| 2026-08-07 | H | Polaridad + Equilibrio Yin-Yang: Dualidad en los negocios |
| 2026-08-08 | C | Efecto Mariposa — Pequeños cambios, grandes consecuencias |
| 2026-08-09 | B | Ley de Compensación — Da más de lo esperado |
| 2026-08-10 | A | El Kybalión y las Siete Leyes como Sistema Unificado |
| 2026-08-11 | B | Ley de No Resistencia — No luchar contra lo que es |
| 2026-08-12 | C | Ley de Murphy — Si puede salir mal, saldrá |
| 2026-08-13 | H | Mindfulness: Vivir en el presente (Thich Nhat Hanh) |
| 2026-08-14 | H | Gravedad + Sacrificio: El peso de las decisiones |
| 2026-08-15 | B | Ley de Perdón — Soltar el rencor libera energía |
| 2026-08-17 | A | La Tabla Esmeralda: El Documento Más Antiguo de la Sabiduría Universal |
| 2026-08-18 | B | Ley de Sacrificio — Para ganar algo, se deja algo |
| 2026-08-19 | C | Principio de Incertidumbre de Heisenberg — No puedes controlar todo |
| 2026-08-21 | H | Conservación de Energía + Séneca: Toda energía que inviertes se transforma |
| 2026-08-22 | H | Sincronicidad: La Ley de las Conexiones Significativas |
| 2026-08-23 | H | Ley de la Resonancia Universal — Todo vibra en frecuencias que se buscan mutuamente |
| 2026-08-26 | C | Efecto Doppler — Por qué la realidad cambia según te mueves hacia ella |
| 2026-08-27 | H | Séneca: La Dichotomía del Control y la Libertad Interior |
| 2026-08-28 | H | Ritmo + Atracción: Cómo sincronizar tus ciclos con el universo |
